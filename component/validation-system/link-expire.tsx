    ...
    return (
        <Center bg="black" pos="fixed" width="100%" h="100%">
            <Alert display={'block'} bg={"blackAlpha.900"} color="white" maxWidth={['100%', '500px']} status='error'>
                ...
                <Text>This Link is Expired. Create new room or get another link from administator. <br />  <Link href={"/"} >< Button fontWeight={100} colorScheme={'white'} my={5} variant={'outline'}>
